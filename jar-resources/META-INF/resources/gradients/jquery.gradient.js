...
(function ($) {
    ...
    $.fn.gradient = function (options) {
        ...
        return this.each(function () {
            var $this = $(this), width = $this.innerWidth(), height = $this.innerHeight(), x = 0, y = 0, w = 1, h = 1,
                html = [],
            ...
            $this
                .html('<div style="display:' + $this.css("display") + '; position: relative; z-index: 2;height:100%">' + this.innerHTML + '</div>')
                .prepend(html.join(''));
        });
    };
